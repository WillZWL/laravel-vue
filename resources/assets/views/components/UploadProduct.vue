      ...
      <div class="x_panel">
        ...
        <div class="x_content">
          <blockquote>
            ...
            <p class="col-md-3 col-xs-12"><a href="http://admincentre.eservicesgroup.com:7890/product-upload/donwload-example-file/UploadExample.csv">Download Example File <strong><i class="fa fa-download"></i></strong></a></p>
          <div class="clearfix"></div>
          </blockquote>
