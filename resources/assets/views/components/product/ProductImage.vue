...
<template>
  <div id="productImageDiv" class="x_panel">
    ...
    <div class="x_content">
      <div>
      <div v-if='productImages'>{{productImages}}</div>
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form id="fileupload" action="{{apiUrl}}upload-product-image" method="POST" enctype="multipart/form-data">
  ...
  export default {
    ...
    methods: {
      ...
      $('#fileupload').fileupload({
        ...
        url: this.apiUrl+'upload-product-image?access_token='+access_token
      });
      ...
      var access_token = 'PooJTPgDFLIYJ5dkPlPuceViYo7nYZAhU4PDo8sP';
